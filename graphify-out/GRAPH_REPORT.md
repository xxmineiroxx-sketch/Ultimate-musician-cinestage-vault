# Graph Report - Ultimate-musician-cinestage-vault  (2026-08-15)

## Corpus Check
- 508 files · ~722,486 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30808 nodes · 41328 edges · 12210 communities (10281 shown, 1929 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 189 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ce600db4`
...
3. `around()` - 59 edges
4. `getSongs()` - 56 edges
5. `addOrUpdateSong()` - 56 edges
6. `handlePost()` - 56 edges
7. `around()` - 55 edges
8. `nowIso()` - 50 edges
...
- `HomeScreen()` --calls--> `formatUpcomingServiceDate()`  [EXTRACTED]
  src/screens/HomeScreen.js → apps/primary_app/ultimate_musician_full_project_v3/mobile/screens/HomeScreen.js
- `HomeScreen()` --calls--> `getVerseByDay()`  [EXTRACTED]
  src/screens/HomeScreen.js → apps/ultimate_daw/src/renderer/screens/HomeScreen.jsx
- `HomeScreen()` --calls--> `getDailyReadingPlan()`  [EXTRACTED]
  src/screens/HomeScreen.js → apps/ultimate_daw/src/renderer/screens/HomeScreen.jsx

## Communities (12210 total, 1929 thin omitted)
...
Cohesion: 0.05
Nodes (154): folly(), absolutizeStemAsset(), absolutizeStemMap(), absolutizeStemUrl(), activeDesktopWorkerFor(), actorCanApproveSetlist(), addSystemMessage(), applyChartToSong() (+146 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (94): ensureCifrasSeeded(), removeCifrasSongs(), safeJsonParse(), bassTemplate(), demoRoles(), demoServicePlan(), demoSettings(), demoSongs() (+86 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (67): getOutputOptions(), formatSeconds(), LiveServiceScreen(), parseLengthToSeconds(), formatSeconds(), LiveServiceScreen(), parseLengthToSeconds(), canOpenCineStage() (+59 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (52): getActiveCineStageUrl(), getCachedCineStageUrl(), makeId(), clearSongs(), findSongDuplicate(), ensureTblcSeeded(), getTblcCount(), CineStageDashboardScreen() (+44 more)
...
Cohesion: 0.03
Nodes (20): AuthProvider(), isGuestUserId(), normalizePendingVerification(), parsePendingVerification(), getLibraryGroupLabel(), normalizeAggregateLibraryPayload(), getLibraryGroupLabel(), normalizeAggregateLibraryPayload() (+12 more)
...
Cohesion: 0.06
Nodes (58): checkBackendHealth(), scanDevices(), testDeviceRecall(), triggerPreset(), analyzeAudio(), analyzeSongArrangement(), analyzeTheory(), analyzeWaveform() (+50 more)
...
Cohesion: 0.05
Nodes (29): CineStageBrainStatus(), formatCheckedAt(), hostLabel(), CineStageBrainStatus(), formatCheckedAt(), hostLabel(), ThemeProvider(), useTheme() (+21 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (40): applyMarkerType(), bytesToBase64(), coerceMarkerType(), DawChannelStrip(), dawStemColor(), formatTime(), formatVerticalTrackLabel(), getMarkerTypeMeta() (+32 more)
...
Cohesion: 0.12
Nodes (36): useAuth(), LoginScreen(), ResetPasswordScreen(), VerifyScreen(), changePassword(), clearPendingRegistrationProfile(), completeAuthFromResponse(), createSyncError() (+28 more)
...
Cohesion: 0.09
Nodes (32): clearDeletedServiceIds(), createService(), deleteService(), getActiveServiceId(), getDeletedServiceIds(), getJSON(), getServices(), getUpcomingServices() (+24 more)
...
Cohesion: 0.06
Nodes (16): PodsDummy_EXManifests, PodsDummy_expo_dev_launcher, PodsDummy_expo_dev_menu, PodsDummy_expo_dev_menu_interface, PodsDummy_ExpoBlur, PodsDummy_ExpoFont, PodsDummy_ExpoModulesCore, PodsDummy_ExpoSpeech (+8 more)
...
Cohesion: 0.14
Nodes (26): createAssignment(), createBlockoutDate(), createConversation(), createMessage(), createService(), createSetlist(), createSong(), createUserProfile() (+18 more)
...
Cohesion: 0.19
Nodes (21): ensureScopedLegacyMigration(), getLegacyOwnerKey(), getLegacyRecordKey(), getScopedRecordItem(), getScopedRecordKey(), getScopedRecordKeyForOrg(), getScopedRecordOwnerKey(), getScopedRecordPrefix() (+13 more)
...
Cohesion: 0.12
Nodes (14): chapterAtIndex(), chapterRangeForDay(), dayOfYear(), formatDate(), formatTime(), getDailyReadingPlan(), getMonthKey(), getThemeByDate() (+6 more)
...
Cohesion: 0.24
Nodes (7): estimateDuration(), extractYouTubeId(), getChordPreview(), getInstrumentChart(), hasStemsAvailable(), SetlistScreen(), SongCard()
...
Cohesion: 0.2
Nodes (6): formatSongCount(), formatUpcomingServiceDate(), getGreeting(), groupByService(), HomeScreen(), useResponsive()

### Community 380 - "Community 380"
Cohesion: 0.27
Nodes (4): CineStageBrainScreen(), computeBriefs(), serviceCountdown(), songEnergy()
...
Cohesion: 0.39
Nodes (5): BrainPanel(), getDisplayName(), getInitial(), TopBar(), useBrain()
...
- **1929 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `syncHeaders()` connect `Community 19` to `Community 128`, `Community 129`, `Community 130`, `Community 3`, `Community 266`, `Community 143`, `Community 31`, `Community 32`, `Community 34`, `Community 290`, `Community 38`, `Community 58`, `Community 59`, `Community 62`, `Community 64`, `Community 326`, `Community 202`, `Community 203`, `Community 82`, `Community 83`, `Community 91`, `Community 95`, `Community 229`, `Community 230`, `Community 118`, `Community 376`, `Community 380`, `Community 127`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `syncHeaders()` connect `Community 12` to `Community 3`, `Community 4`, `Community 5`, `Community 16`, `Community 18`, `Community 22`, `Community 29`, `Community 31`, `Community 34`, `Community 293`, `Community 47`, `Community 50`, `Community 51`, `Community 54`, `Community 1214`, `Community 1215`, `Community 73`, `Community 74`, `Community 99`, `Community 1020`, `Community 1021`, `Community 127`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `addOrUpdateSong()` connect `Community 41` to `Community 3`, `Community 4`, `Community 5`, `Community 74`, `Community 12`, `Community 16`, `Community 51`, `Community 22`, `Community 95`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Are the 2 inferred relationships involving `getSongs()` (e.g. with `getScopedItem()` and `setScopedItem()`) actually correct?**
  _`getSongs()` has 2 INFERRED edges - model-reasoned connections that need verification._
