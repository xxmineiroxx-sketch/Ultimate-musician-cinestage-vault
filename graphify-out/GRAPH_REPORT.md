# Graph Report - Ultimate-musician-cinestage-vault  (2026-08-08)

## Corpus Check
- 565 files · ~750,362 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30729 nodes · 40998 edges · 12214 communities (10284 shown, 1930 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 128 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `76781de7`
...
1. `syncHeaders()` - 62 edges
2. `CineStageAPI` - 60 edges
3. `around()` - 59 edges
4. `addOrUpdateSong()` - 55 edges
5. `around()` - 55 edges
6. `getSongs()` - 54 edges
7. `handlePost()` - 49 edges
8. `AudioEngine` - 46 edges
9. `syncHeaders()` - 45 edges
10. `nowIso()` - 39 edges
...
## Communities (12214 total, 1930 thin omitted)
...
Cohesion: 0.07
Nodes (116): folly(), activeDesktopWorkerFor(), addSystemMessage(), applyChartToSong(), applyStemJobToSong(), assignmentsFor(), assignmentStatsFor(), authChallengeCode() (+108 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (47): CineStageDashboardScreen(), AnalysisResult(), CineStageScreenIPhone17(), fmtMs(), AnalysisResult(), CineStageScreenIPhone17(), fmtMs(), syncHeaders() (+39 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (52): getActiveCineStageUrl(), getCachedCineStageUrl(), makeId(), addOrUpdatePerson(), addOrUpdateService(), addOrUpdateSong(), clearSongs(), deletePerson() (+44 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (57): formatSeconds(), LiveServiceScreen(), parseLengthToSeconds(), formatSeconds(), LiveServiceScreen(), parseLengthToSeconds(), Avatar(), avatarColor() (+49 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (62): buildStemMap(), findWavFiles(), scanStemOutput(), separateStems(), defaultConfig(), normalizeIdentifier(), readConfig(), savedIdentity() (+54 more)
...
Cohesion: 0.06
Nodes (26): applyLatencyCompensationSec(), buildAdvancedWavePipeline(), buildJumpTargets(), buildPeakPyramid(), buildTransientMarkers(), clamp(), colorFor(), cueTimeSec() (+18 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (47): applyMarkerType(), bytesToBase64(), coerceMarkerType(), DawChannelStrip(), dawStemColor(), formatTime(), formatVerticalTrackLabel(), getMarkerTypeMeta() (+39 more)
...
Cohesion: 0.06
Nodes (44): clearDeletedServiceIds(), createService(), deleteService(), getActiveServiceId(), getDeletedServiceIds(), getJSON(), getServices(), getUpcomingServices() (+36 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (26): fetchRemoteGrantRole(), ServiceCommandCenter(), serviceCountdown(), songEnergy(), syncHeaders(), BlockoutCalendarScreen(), formatDateKey(), normalizeBlockoutEntry() (+18 more)
...
Cohesion: 0.07
Nodes (36): ensureScopedLegacyMigration(), getLegacyOwnerKey(), getLegacyRecordKey(), getScopedItem(), getScopedRecordItem(), getScopedRecordKey(), getScopedRecordKeyForOrg(), getScopedRecordOwnerKey() (+28 more)
...
Cohesion: 0.06
Nodes (15): RedirectIfAuth(), RequireAuth(), RootRedirect(), useAuth(), InlineCalendar(), todayStr(), LoginScreen(), formatTime() (+7 more)
...
Cohesion: 0.13
Nodes (35): buildPersonalTracks(), buildTrackSources(), collectPracticeStemEntries(), detectPrimaryRole(), entryMatchesStem(), extractPlayableStemUri(), findSongIndex(), findStemEntry() (+27 more)
...
Cohesion: 0.06
Nodes (8): useAuth(), AnalyticsDashboardScreen(), coverageColor(), RoleBar(), AnalyticsDashboardScreen(), coverageColor(), RoleBar(), VerifyScreen()
...
Cohesion: 0.06
Nodes (16): PodsDummy_EXJSONUtils, PodsDummy_expo_dev_launcher, PodsDummy_expo_dev_menu, PodsDummy_expo_dev_menu_interface, PodsDummy_ExpoAsset, PodsDummy_ExpoBlur, PodsDummy_ExpoSpeech, PodsDummy_EXUpdates (+8 more)

### Community 65 - "Community 65"
Cohesion: 0.11
Nodes (34): analyzeAudio(), analyzeSongArrangement(), analyzeTheory(), buildMusicAiJobId(), createDAWTemplateWithAI(), createJob(), createMidiPreset(), generateCues() (+26 more)

### Community 66 - "Community 66"
Cohesion: 0.1
Nodes (26): formatTime(), PerformanceScreen(), queueItemFromSong(), stemsResultFromLocalStems(), applyLatencyCompensationSeconds(), getLatencyCalibration(), getTotalLatencyMs(), saveLatencyCalibration() (+18 more)
...
Cohesion: 0.15
Nodes (32): acceptAssignment(), declineAssignment(), findTeamMemberIndex(), getAssignmentsByPersonId(), getEffectiveInviteStatus(), getMessagesByRecipient(), getServiceById(), getSharedAssignments() (+24 more)
...
Cohesion: 0.13
Nodes (25): WaveformTimeline(), mergeSuggestedMarkers(), suggestAiMarkers(), applyLatencyCompensationSec(), asSeconds(), buildAdvancedWavePipeline(), buildJumpTargets(), buildPeakPyramid() (+17 more)
...
Cohesion: 0.09
Nodes (14): BrainPanel(), getDisplayName(), getInitial(), TopBar(), BrainProvider(), useBrain(), RedirectIfAuth(), RequireAuth() (+6 more)
...
Cohesion: 0.1
Nodes (12): CineStageBrainStatus(), formatCheckedAt(), hostLabel(), CineStageBrainStatus(), formatCheckedAt(), hostLabel(), useTheme(), BridgeSetupScreen() (+4 more)
...
Cohesion: 0.09
Nodes (9): buildAlignedWaveformCues(), buildFallbackWaveformCues(), buildLyricsExcerpt(), defaultSectionParts(), getPreviewChartForInstrument(), normalizeRoleKey(), normalizeSectionDraft(), normalizeSectionRole() (+1 more)
...
Cohesion: 0.09
Nodes (6): getStemPeaks(), extractStemUrls(), getStemWaveformData(), downloadStemsToDesktop(), fetchStemPeaksViaDesktop(), pickAudioFileDesktop()
...
Cohesion: 0.23
Nodes (20): addAssignment(), addBlockoutDate(), addMessage(), clearAllData(), deleteBlockoutDate(), getAssignments(), getBlockoutDates(), getConversations() (+12 more)
...
Cohesion: 0.17
Nodes (12): isVocalRole(), PartSheetScreen(), colorHex(), StageDisplayScreen(), startStickySync(), stopStickySync(), connectSync(), disconnectSync() (+4 more)
...
Cohesion: 0.15
Nodes (13): buildSectionWindows(), formatTime(), getSectionWindow(), getStemRole(), StemMixerScreen(), TrackCard(), buildActiveStems(), extractStemUrls() (+5 more)
...
Cohesion: 0.19
Nodes (17): del(), get(), getAiRecommendations(), getAssignments(), getLiveStatus(), getMessageReplies(), getMessages(), getOrgPlan() (+9 more)
...
Cohesion: 0.28
Nodes (14): buildPhotoDataUrl(), cancelStoredServiceReminders(), findRemotePersonMatch(), formatMemberSince(), getPreferredSyncedPhotoUrl(), inferPhotoMimeType(), isPortablePhotoUrl(), normalizeNotificationPreferences() (+6 more)
...
Cohesion: 0.17
Nodes (4): generate_uniform_real(), param_type, uniform_real_distribution, eng()
...
Cohesion: 0.34
Nodes (13): buildAdminEventKeys(), buildAssignmentEventKeys(), buildPersonalEventKeys(), createAbortSignal(), fetchAdminKeys(), fetchAssignmentKeys(), fetchJson(), fetchPersonalKeys() (+5 more)
...
Cohesion: 0.16
Nodes (6): AuthProvider(), isGuestUserId(), normalizePendingVerification(), parsePendingVerification(), ErrorBoundary, ThemedNavigator()
...
Cohesion: 0.21
Nodes (8): checkBackendHealth(), scanDevices(), testDeviceRecall(), triggerPreset(), analyzeWaveform(), getABStatus(), getCineStageHealth(), getWaveformCues()
...
Cohesion: 0.27
Nodes (9): ExternalSyncScreen(), connectBridge(), disconnectBridge(), getBridgeUrl(), notify(), subscribeBridge(), isBridgeReady(), sendCue() (+1 more)

### Community 298 - "Community 298"
Cohesion: 0.21
Nodes (12): bootstrapBrain(), buildBootstrapPayload(), fetchBrainBootstrapFromBase(), fetchBrainCapabilitiesFromBase(), getBrainAuthority(), getBrainBaseCandidates(), getBrainCapabilities(), getStemProcessingRoute() (+4 more)
...
Cohesion: 0.35
Nodes (9): cycleNextPadKit(), getActivePadKit(), getActivePadKitId(), getPadKits(), importPadKitFromJsonText(), normalizeKit(), parsePadKitJson(), saveImportedPadKit() (+1 more)
...
Cohesion: 0.29
Nodes (4): clearCineStageStatus(), _notify(), setCineStageStatus(), subscribeToCineStageStatus()
...
Cohesion: 0.4
Nodes (8): enqueueMessage(), fetchJson(), flushMessageOutbox(), formatTime(), getMessageOutbox(), isPersonalInboxMessage(), MessagesScreen(), saveMessageOutbox()
...
Cohesion: 0.6
Nodes (4): ensureAudioMode(), playNotificationSequence(), playNotificationSound(), playSoundNow()
...
Cohesion: 0.6
Nodes (4): fetchJson(), ProposalsScreen(), syncApprovedSongToLibrary(), timeAgo()
...
Cohesion: 0.67
Nodes (4): buildSafeScanResult(), isMissingMidiRuntime(), normalizeScanResult(), scanDevices()

## Knowledge Gaps
- **6 isolated node(s):** `notReachable`, `reachableViaWiFi`, `reachableViaWWAN`, `unavailable`, `wifi` (+1 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **1930 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `syncHeaders()` connect `Community 24` to `Community 385`, `Community 387`, `Community 4`, `Community 141`, `Community 142`, `Community 143`, `Community 23`, `Community 30`, `Community 169`, `Community 45`, `Community 49`, `Community 52`, `Community 53`, `Community 185`, `Community 58`, `Community 60`, `Community 68`, `Community 73`, `Community 205`, `Community 206`, `Community 207`, `Community 80`, `Community 334`, `Community 84`, `Community 89`, `Community 94`, `Community 108`, `Community 237`, `Community 236`, `Community 127`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `CineStageAPI` connect `Community 10` to `Community 385`, `Community 58`, `Community 3`, `Community 4`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `syncHeaders()` connect `Community 3` to `Community 4`, `Community 137`, `Community 12`, `Community 15`, `Community 19`, `Community 23`, `Community 30`, `Community 32`, `Community 42`, `Community 299`, `Community 47`, `Community 184`, `Community 60`, `Community 1216`, `Community 65`, `Community 67`, `Community 74`, `Community 96`, `Community 235`, `Community 127`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
