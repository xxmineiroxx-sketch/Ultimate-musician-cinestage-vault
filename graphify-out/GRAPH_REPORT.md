# Graph Report - Ultimate-musician-cinestage-vault  (2026-08-09)

## Corpus Check
- 565 files · ~760,612 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30804 nodes · 41251 edges · 12218 communities (10286 shown, 1932 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 128 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7fe59481`
...
1. `syncHeaders()` - 63 edges
2. `CineStageAPI` - 63 edges
3. `around()` - 59 edges
4. `addOrUpdateSong()` - 56 edges
5. `handlePost()` - 56 edges
6. `around()` - 55 edges
7. `getSongs()` - 54 edges
8. `nowIso()` - 50 edges
9. `AudioEngine` - 49 edges
10. `syncHeaders()` - 45 edges
...
- `getRoles()` --calls--> `safeJsonParse()`  [EXTRACTED]
  apps/primary_app/ultimate_musician_full_project_v3/mobile/data/storage.js → src/data/storage.js
- `HomeScreen()` --calls--> `formatSongCount()`  [EXTRACTED]
  src/screens/HomeScreen.js → apps/primary_app/ultimate_musician_full_project_v3/mobile/screens/HomeScreen.js
- `HomeScreen()` --calls--> `formatUpcomingServiceDate()`  [EXTRACTED]
  src/screens/HomeScreen.js → apps/primary_app/ultimate_musician_full_project_v3/mobile/screens/HomeScreen.js
- `HomeScreen()` --calls--> `groupByService()`  [EXTRACTED]
  src/screens/HomeScreen.js → apps/ultimate_daw/src/renderer/screens/HomeScreen.jsx

## Communities (12218 total, 1932 thin omitted)
...
Cohesion: 0.05
Nodes (150): folly(), absolutizeStemAsset(), absolutizeStemMap(), absolutizeStemUrl(), activeDesktopWorkerFor(), addSystemMessage(), applyChartToSong(), applyStemJobToSong() (+142 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (50): getActiveCineStageUrl(), getCachedCineStageUrl(), makeId(), addOrUpdatePerson(), addOrUpdateService(), addOrUpdateSong(), clearSongs(), deletePerson() (+42 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (52): CineStageDashboardScreen(), AnalysisResult(), CineStageScreenIPhone17(), fmtMs(), AnalysisResult(), CineStageScreenIPhone17(), fmtMs(), NewSongScreen() (+44 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (47): formatSeconds(), LiveServiceScreen(), parseLengthToSeconds(), formatSeconds(), LiveServiceScreen(), parseLengthToSeconds(), Avatar(), avatarColor() (+39 more)
...
Cohesion: 0.05
Nodes (13): CineStageAPI, CineStageBrainStatus(), formatCheckedAt(), hostLabel(), CineStageBrainStatus(), formatCheckedAt(), hostLabel(), CineStageBrainScreen() (+5 more)
...
Cohesion: 0.06
Nodes (44): indexToNote(), noteIndex(), semitonesBetween(), shouldUseFlatsForKey(), stripChordsForVocals(), transposeChordChart(), transposeChordToken(), addSongToService() (+36 more)
...
Cohesion: 0.06
Nodes (54): bassTemplate(), demoRoles(), demoServicePlan(), demoSettings(), demoSongs(), drumsTemplate(), guitarTemplate(), keysTemplate() (+46 more)
...
Cohesion: 0.06
Nodes (29): fetchRemoteGrantRole(), syncHeaders(), BlockoutCalendarScreen(), formatDateKey(), normalizeBlockoutEntry(), normalizeDateKey(), parseDateKey(), serverBlockout() (+21 more)
...
Cohesion: 0.07
Nodes (53): analyzeAudio(), analyzeSongArrangement(), analyzeTheory(), analyzeWaveform(), bootstrapBrain(), buildBootstrapPayload(), buildMusicAiJobId(), buildSafeScanResult() (+45 more)
...
Cohesion: 0.07
Nodes (43): clearDeletedServiceIds(), createService(), deleteService(), getActiveServiceId(), getDeletedServiceIds(), getJSON(), getServices(), getUpcomingServices() (+35 more)
...
Cohesion: 0.05
Nodes (10): syncHeaders(), getTimeAgo(), MessageCenterScreen(), normalizeOrgRole(), PermissionsScreen(), ProfileScreen(), fetchJson(), ProposalsScreen() (+2 more)
...
Cohesion: 0.08
Nodes (36): getEffectiveInviteStatus(), getNextSundayStr(), normalizeInviteStatus(), PersonCard(), shouldShowInviteAction(), approveProposal(), createBlockout(), debugStatus() (+28 more)
...
Cohesion: 0.11
Nodes (37): deletePersonFromCloud(), normalizeInviteStatus(), PersonProfileScreen(), shouldShowInviteAction(), acceptAssignment(), declineAssignment(), findTeamMemberIndex(), getAssignmentsByPersonId() (+29 more)

### Community 49 - "Community 49"
Cohesion: 0.1
Nodes (21): AppErrorBoundary, FeedbackScreen(), buildPayload(), clipText(), createCrashFeedbackDraft(), createFingerprint(), createManualFeedbackDraft(), deliverFeedbackDraft() (+13 more)
...
Cohesion: 0.13
Nodes (21): calculateSemitoneShift(), createAxeFXPreset(), createEffectPreset(), createHelixPreset(), createKemperRig(), createMODXPerformance(), createNordProgram(), createSectionMapping() (+13 more)
...
Cohesion: 0.09
Nodes (38): del(), get(), getAiRecommendations(), getAssignments(), getAssignmentTracking(), getLiveStatus(), getMessageReplies(), getMessages() (+30 more)

### Community 56 - "Community 56"
Cohesion: 0.12
Nodes (36): buildPersonalTracks(), buildTrackSources(), collectPracticeStemEntries(), detectPrimaryRole(), entryMatchesStem(), extractPlayableStemUri(), findSongIndex(), findStemEntry() (+28 more)
...
Cohesion: 0.06
Nodes (15): CineStageBrainStatus(), formatCheckedAt(), hostLabel(), CineStageBrainStatus(), formatCheckedAt(), hostLabel(), useTheme(), ErrorBoundary (+7 more)
...
Cohesion: 0.07
Nodes (13): RedirectIfAuth(), RequireAuth(), RootRedirect(), useAuth(), formatTime(), MessagesScreen(), VerifyScreen(), authIdentifier() (+5 more)
...
Cohesion: 0.15
Nodes (33): addNameVariants(), buildAssignmentLookup(), buildDisplayName(), buildPeopleById(), buildPresetPatchEntries(), buildPresetPayload(), buildProfileLookup(), capoShapesKey() (+25 more)

### Community 68 - "Community 68"
Cohesion: 0.13
Nodes (28): ensureCifrasSeeded(), removeCifrasSongs(), safeJsonParse(), ensureScopedLegacyMigration(), getLegacyOwnerKey(), getLegacyRecordKey(), getScopedItem(), getScopedRecordItem() (+20 more)
...
Cohesion: 0.06
Nodes (15): PodsDummy_EASClient, PodsDummy_EXJSONUtils, PodsDummy_expo_dev_launcher, PodsDummy_expo_dev_menu, PodsDummy_expo_dev_menu_interface, PodsDummy_ExpoBlur, PodsDummy_ExpoHaptics, PodsDummy_ExpoModulesCore (+7 more)
...
Cohesion: 0.08
Nodes (12): PresetsScreen(), buildAlignedWaveformCues(), buildFallbackWaveformCues(), buildLyricsExcerpt(), defaultSectionParts(), getPreviewChartForInstrument(), normalizeRoleKey(), normalizeSectionDraft() (+4 more)
...
Cohesion: 0.09
Nodes (18): buildSectionWindows(), formatTime(), getSectionWindow(), getStemRole(), StemMixerScreen(), TrackCard(), stemColor(), WaveformDetailScreen() (+10 more)
...
Cohesion: 0.19
Nodes (25): addAssignment(), addBlockoutDate(), addMessage(), clearAllData(), deleteBlockoutDate(), getAssignments(), getBlockoutDates(), getConversations() (+17 more)
...
Cohesion: 0.15
Nodes (18): asNumber(), cacheKey(), cacheWaveform(), cueSectionsToMarkers(), enrichWaveform(), fetchServerWaveform(), firstNonEmptyArray(), getWaveformAnalysis() (+10 more)
...
Cohesion: 0.16
Nodes (22): AssignmentsScreen(), buildAcceptConflictMessage(), cancelRemindersForService(), dedupAssignments(), enqueueAssignmentResponse(), flushAssignmentResponseOutbox(), formatConflictDate(), getAssignmentResponseOutbox() (+14 more)
...
Cohesion: 0.1
Nodes (10): getLibraryGroupLabel(), normalizeAggregateLibraryPayload(), getLibraryGroupLabel(), normalizeAggregateLibraryPayload(), broadcastToRoom(), clearBranchConfig(), hasBranchConfig(), loadBranchConfig() (+2 more)
...
Cohesion: 0.09
Nodes (3): fmtTime(), StudioScreenWeb(), TransportBar()

### Community 122 - "Community 122"
Cohesion: 0.19
Nodes (17): asNumber(), cacheKey(), cacheWaveform(), cueSectionsToMarkers(), enrichWaveform(), fetchServerWaveform(), firstNonEmptyArray(), getWaveformAnalysis() (+9 more)
...
Cohesion: 0.17
Nodes (13): extractYouTubeId(), fmtSec(), LivePerformanceScreen(), normalizeSections(), asNumber(), buildFallbackSections(), buildSongWaveAnalysisPatch(), firstNonEmptyArray() (+5 more)
...
Cohesion: 0.14
Nodes (9): ThemeProvider(), CueGridScreen(), DronePadScreen(), sendPitchShift(), autoAssignLightingCues(), autoAssignLyricsCues(), defaultSession(), saveSession() (+1 more)
...
Cohesion: 0.11
Nodes (3): downloadStemsToDesktop(), fetchStemPeaksViaDesktop(), pickAudioFileDesktop()
...
Cohesion: 0.24
Nodes (13): sendBridge(), hexToRgb(), sendLoopState(), sendSectionCue(), sendTransport(), continueClock(), restart(), sendRaw() (+5 more)
...
Cohesion: 0.23
Nodes (10): getActiveOrgId(), getActiveSecretKey(), registerExpoPushToken(), sendLoginNotification(), kickStemJob(), analyzeWorshipSession(), analyzeWorshipSong(), broadcastWorshipFreelyEvent() (+2 more)
...
Cohesion: 0.17
Nodes (6): formatBar(), formatTime(), meterColor(), pad(), TrackStrip(), TransportBar()
...
Cohesion: 0.4
Nodes (10): asNumber(), buildFallbackSections(), buildSongWaveAnalysisPatch(), firstNonEmptyArray(), loadSongWavePipeline(), normalizeSectionWindows(), pickFirstResolvedUrl(), resolveDurationMs() (+2 more)

### Community 334 - "Community 334"
Cohesion: 0.31
Nodes (9): buildFallbackTrackPreview(), buildTracks(), entryPriority(), getBackendStemKeys(), hasBackendStemEntries(), normalizeBackendStemEntries(), pushEntry(), stemAudioKey() (+1 more)
...
Cohesion: 0.29
Nodes (5): checkBackendHealth(), scanDevices(), testDeviceRecall(), triggerPreset(), getCineStageHealth()
...
Cohesion: 0.29
Nodes (5): extractYouTubeId(), getChordPreview(), getInstrumentChart(), hasStemsAvailable(), SongCard()
...
Cohesion: 0.33
Nodes (6): FatChannelPresetsScreen(), base64ToBytes(), bytesToBase64(), getPresetInstallStatus(), installPresetsFromBundle(), normalizeEntryPath()
...
Cohesion: 0.31
Nodes (5): canTriggerWorshipFlow(), canViewWorshipFlow(), estimateDuration(), normalizeRoleKey(), SetlistScreen()
...
Cohesion: 0.29
Nodes (8): analyzeChartRequest(), bestChartForSong(), extractChartInfo(), finalizeRecord(), findLibraryMatch(), isIcloudDocumentPath(), readTextChart(), rtfToText()
...
Cohesion: 0.47
Nodes (3): ServiceCommandCenter(), serviceCountdown(), songEnergy()

### Community 1099 - "Community 1099"
Cohesion: 0.47
Nodes (4): AuthProvider(), isGuestUserId(), normalizePendingVerification(), parsePendingVerification()
...
- **Why does `syncHeaders()` connect `Community 25` to `Community 385`, `Community 130`, `Community 3`, `Community 4`, `Community 131`, `Community 389`, `Community 144`, `Community 275`, `Community 28`, `Community 157`, `Community 171`, `Community 49`, `Community 52`, `Community 55`, `Community 57`, `Community 58`, `Community 61`, `Community 62`, `Community 67`, `Community 1096`, `Community 75`, `Community 331`, `Community 206`, `Community 207`, `Community 208`, `Community 82`, `Community 92`, `Community 97`, `Community 236`, `Community 109`, `Community 237`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `addOrUpdateSong()` connect `Community 3` to `Community 97`, `Community 4`, `Community 5`, `Community 38`, `Community 43`, `Community 76`, `Community 13`, `Community 17`, `Community 51`, `Community 30`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `syncHeaders()` connect `Community 38` to `Community 3`, `Community 4`, `Community 131`, `Community 13`, `Community 17`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 43`, `Community 300`, `Community 46`, `Community 48`, `Community 68`, `Community 71`, `Community 1099`, `Community 76`, `Community 87`, `Community 112`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
