# Graph Report - Ultimate-musician-cinestage-vault-audit  (2026-08-01)

## Corpus Check
- 35217 files · ~24,480,536 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30614 nodes · 40708 edges · 12208 communities (10276 shown, 1932 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 115 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4757c461`
...
1. `syncHeaders()` - 59 edges
2. `around()` - 59 edges
3. `addOrUpdateSong()` - 55 edges
4. `around()` - 55 edges
5. `CineStageAPI` - 55 edges
6. `getSongs()` - 54 edges
7. `AudioEngine` - 46 edges
8. `syncHeaders()` - 44 edges
9. `handlePost()` - 39 edges
10. `http()` - 35 edges
...
Cohesion: 0.06
Nodes (57): getActiveCineStageUrl(), getCachedCineStageUrl(), makeId(), addOrUpdatePerson(), addOrUpdateService(), addOrUpdateSong(), clearSongs(), deletePerson() (+49 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (92): folly(), activeDesktopWorkerFor(), addSystemMessage(), applyChartToSong(), applyStemJobToSong(), assignmentsFor(), assignmentStatsFor(), authResponse() (+84 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (40): CineStageBrainStatus(), formatCheckedAt(), hostLabel(), CineStageBrainStatus(), formatCheckedAt(), hostLabel(), ThemeProvider(), useTheme() (+32 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (49): formatSeconds(), LiveServiceScreen(), parseLengthToSeconds(), formatSeconds(), LiveServiceScreen(), parseLengthToSeconds(), Avatar(), avatarColor() (+41 more)
...
Cohesion: 0.05
Nodes (39): fetchRemoteGrantRole(), ServiceCommandCenter(), serviceCountdown(), songEnergy(), syncHeaders(), BlockoutCalendarScreen(), formatDateKey(), normalizeBlockoutEntry() (+31 more)
...
Cohesion: 0.06
Nodes (30): buildLiveSectionJumpList(), countExplicitSectionTimes(), countMeaningfulSectionLabels(), cueSideText(), defaultTrackRouting(), fmtSec(), formatRoleLabel(), getSectionTimeSec() (+22 more)
...
Cohesion: 0.07
Nodes (42): clearDeletedServiceIds(), createService(), deleteService(), getActiveServiceId(), getDeletedServiceIds(), getJSON(), getServices(), getUpcomingServices() (+34 more)
...
Cohesion: 0.05
Nodes (9): useAuth(), AnalyticsDashboardScreen(), coverageColor(), RoleBar(), AnalyticsDashboardScreen(), coverageColor(), RoleBar(), LoginScreen() (+1 more)

### Community 52 - "Community 52"
Cohesion: 0.11
Nodes (36): capoShapesKey(), chartKey(), detectRoleType(), findPlayableSongIndex(), getActiveSectionFromScroll(), getMyPartForSong(), getRoleIcon(), getRoleLabel() (+28 more)
...
Cohesion: 0.1
Nodes (40): analyzeAudio(), analyzeSongArrangement(), analyzeTheory(), analyzeWaveform(), buildMusicAiJobId(), buildSafeScanResult(), createDAWTemplateWithAI(), createJob() (+32 more)
...
Cohesion: 0.11
Nodes (21): buildStemMap(), findWavFiles(), scanStemOutput(), separateStems(), cacheKeyFor(), cleanUrl(), contentTypeForFile(), defaultRoleStemMap() (+13 more)
...
Cohesion: 0.13
Nodes (35): AdminDashboardScreen(), assignmentMessageMetaText(), assignmentResponseMetaText(), assignmentStatusLabel(), dayNum(), dayShortMonth(), fetchJson(), findAssignedPerson() (+27 more)
...
Cohesion: 0.06
Nodes (16): PodsDummy_EXApplication, PodsDummy_expo_dev_launcher, PodsDummy_expo_dev_menu, PodsDummy_expo_dev_menu_interface, PodsDummy_ExpoBlur, PodsDummy_ExpoHaptics, PodsDummy_ExpoSpeech, PodsDummy_EXStructuredHeaders (+8 more)
...
Cohesion: 0.25
Nodes (6): checkBackendHealth(), scanDevices(), testDeviceRecall(), triggerPreset(), getCineStageHealth(), getWaveformCues()
...
Cohesion: 0.28
Nodes (9): bootstrapBrain(), buildBootstrapPayload(), fetchBrainBootstrapFromBase(), fetchBrainCapabilitiesFromBase(), getBrainBaseCandidates(), getBrainCapabilities(), isBrainOnline(), loadBrainSnapshot() (+1 more)
...
- **Why does `syncHeaders()` connect `Community 12` to `Community 2`, `Community 134`, `Community 137`, `Community 268`, `Community 148`, `Community 149`, `Community 151`, `Community 152`, `Community 31`, `Community 165`, `Community 168`, `Community 47`, `Community 50`, `Community 51`, `Community 52`, `Community 440`, `Community 1081`, `Community 59`, `Community 63`, `Community 64`, `Community 68`, `Community 203`, `Community 80`, `Community 84`, `Community 93`, `Community 229`, `Community 233`, `Community 372`, `Community 379`, `Community 125`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `getActiveOrgId()` connect `Community 114` to `Community 39`, `Community 133`, `Community 71`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `getSongs()` connect `Community 2` to `Community 4`, `Community 5`, `Community 39`, `Community 7`, `Community 46`, `Community 19`, `Community 149`, `Community 28`, `Community 61`, `Community 30`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
