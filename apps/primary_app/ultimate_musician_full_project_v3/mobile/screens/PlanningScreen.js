...
import { makeId, formatRoleLabel } from "../data/models";
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.caption}>
        Calendar, service plans, and team scheduling.
      </Text>
      ...
      {activeService && (
        <View style={styles.card}>
          ...
          {people.map((person) => {
            const assigned = (activeService.assignments || []).find(
              ...
              <View key={person.id} style={styles.assignRow}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.serviceMeta}>
                    {assigned
                      ? `Assigned: ${formatRoleLabel(assigned.role)}`
                      : "Not assigned"}
                  </Text>
                </View>
          ...
          {!people.length && (
            <Text style={styles.caption}>Add team members first.</Text>
          )}
        </View>
      )}
