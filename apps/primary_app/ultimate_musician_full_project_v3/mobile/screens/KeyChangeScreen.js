...
export default function KeyChangeScreen({ route, navigation }) {
  ...
  const handleKeyChange = async () => {
    ...
    try {
      ...
      const semitones = calculateSemitoneShift(song.original_key, selectedKey);
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.infoCard}>
        ...
        {song.current_key && song.current_key !== song.original_key && (
          <>
            ...
            <Text style={styles.infoValue}>
              {calculateSemitoneShift(song.original_key, song.current_key)}{" "}
              semitones
            </Text>
          </>
        )}
      ...
      <View style={styles.infoBox}>
        ...
        <Text style={styles.infoText}>• Select a new key below</Text>
        ...
        <Text style={styles.infoText}>• Device presets remain the same</Text>
      </View>
