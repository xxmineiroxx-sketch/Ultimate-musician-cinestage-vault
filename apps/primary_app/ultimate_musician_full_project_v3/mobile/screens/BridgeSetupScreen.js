  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.p}>
          On a laptop connected to your MIDI/lighting rig, run the bridge
          scripts located in `tools/ultimate-bridge`.
        </Text>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.p}>
          Enter the local IP of the computer running the bridge. This appears on
          the same Wi‑Fi network as your devices.
        </Text>
        <TextInput
          style={styles.input}
          value={host}
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.p}>
          Scan these QR codes with other devices to configure quickly.
        </Text>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.p}>
          Use External Sync to connect MIDI Clock, lighting cues, and lyric
          slides.
        </Text>
        <TouchableOpacity
          style={styles.pill}
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.p}>
          • Keep the bridge laptop on the same Wi‑Fi network.
        </Text>
        <Text style={styles.p}>
          • If sync feels delayed, use wired Ethernet on the host.
        </Text>
        <Text style={styles.p}>
          • When in doubt, restart the bridge scripts before service.
        </Text>
      </View>
    </ScrollView>
  );
