...
const CINESTAGE_STEPS = [
  ...
  "Demucs 4 Separation",
  "Normalizing Audio Peaks",
  "Stems Ready",
];

const STEM_COLORS = {
  vocals: "#EC4899", // Pink
  drums: "#10B981", // Emerald
  bass: "#3B82F6", // Blue
  keys: "#8B5CF6", // Violet
  guitars: "#F59E0B", // Amber
  other: "#FBBF24", // Yellow
};
...
const styles = StyleSheet.create({
  root: { flex: 1, backgroundColor: "#020617", paddingTop: 16 },
  ...
  navLink: { color: "#64748B", fontSize: 13, fontWeight: "600", letterSpacing: 0.5 },
  navSep: { color: "#334155", fontSize: 13 },
  navActive: { color: "#E2E8F0", fontSize: 13, fontWeight: "800", letterSpacing: 0.5 },
  ...
  title: { color: "#F8FAFC", fontSize: 32, fontWeight: "900", letterSpacing: -0.5 },
  titleActions: { flexDirection: "row", gap: 12 },
  ...
  importBtnText: { color: "#60A5FA", fontSize: 14, fontWeight: "800" },
  ...
  addSongBtnText: { color: "#A5B4FC", fontSize: 14, fontWeight: "800" },
  ...
  tblcBannerTitle: { color: "#C4B5FD", fontSize: 16, fontWeight: "900" },
  tblcBannerSub: { color: "#A78BFA", fontSize: 13, fontWeight: "500" },
  ...
  list: { padding: 24, paddingTop: 4, paddingBottom: 80 },
  ...
  cardInfo: { flex: 1 },
  cardTitle: { color: "#F8FAFC", fontSize: 20, fontWeight: "900", letterSpacing: -0.3 },
  cardArtist: { color: "#94A3B8", fontSize: 14, marginTop: 4, fontWeight: "500" },
  cardMeta: { color: "#64748B", fontSize: 12, marginTop: 6, fontWeight: "600" },
  ...
  stemLabel: { color: "#64748B", fontSize: 12, marginLeft: 4, fontWeight: "600" },
  ...
  stemsReadyText: { color: "#34D399", fontSize: 11, fontWeight: "800", textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  cineBtnText: { color: "#A5B4FC", fontSize: 14, fontWeight: "800" },
  ...
  rehearsalBtnText: { color: "#34D399", fontSize: 14, fontWeight: "800" },
  ...
  emptyImportText: { color: "#60A5FA", fontSize: 16, fontWeight: "900" },
