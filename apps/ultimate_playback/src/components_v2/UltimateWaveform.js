...
const SVG_AVAILABLE = Boolean(UIManager?.getViewManagerConfig?.('RNSVGSvgView'));
          ...
          <View
            ...
            style={[
              styles.fallbackBar,
              {
                ...
                width: bar.w,
                height: bar.h,
                backgroundColor: bar.pct <= progress ? accentColor : '#1E293B',
              },
            ]}
          />
        ))}
